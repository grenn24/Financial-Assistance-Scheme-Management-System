...
type HouseholdMember struct {
	Base
	HouseholdOwnerID uuid.UUID     `gorm:"not null" json:"household_owner_id" validate:"required"` //many-to-one
	...
	// Preloadable Columns
	HouseholdOwner *Applicant `gorm:"foreignKey:HouseholdOwnerID ; references:ID"`
}
